<template>
  <div id="about-me-container" class="container bg-neutral-100  sm:max-w-full md:max-w-full lg:max-w-full xl:max-w-full">
    <div class="about-me grid grid-cols-3 gap-8 p-16 m-auto">
      <div class="col-span-2 text-justify">
        ...
        <p class="mb-2">Hey there, I'm Madison Mitchell, a Software Developer with nine years of experience in the dynamic
          world of technology. Throughout my journey, I've honed my skills in a multitude of technologies, including Java,
          C#, .NET, HTML/CSS, JavaScript, Vue.js, SQL Gearset, and Salesforce. It's been an exhilarating ride, navigating
          the ever-changing landscape of code.</p>
        ...
        <div class="flex justify-evenly mt-12">
            ...
            <button class="flex justify-center items-center py-2 px-4 rounded text-white text-center font-semibold w-44" :class="{ 'bg-emerald-500 hover:bg-emerald-700': hideParagraphs, 'bg-amber-500 hover:bg-amber-700': !hideParagraphs }" @click="toggleParagraphs"><span v-html="hideParagraphs ? '<i class=&quot;fa-solid fa-square-plus&quot;></i><span class=&quot;ml-2&quot;>Show More</span>' : '<i class=&quot;fa-solid fa-square-minus&quot;></i><span class=&quot;ml-2&quot;>Show Less</span>'"></span></button>
            <button class="portfolio-btn flex justify-center items-center py-2 px-4 bg-sky-500 hover:bg-sky-700 rounded text-white text-center font-semibold w-44" href=""><i class="fa-solid fa-circle-arrow-right"></i><span class="ml-2">View Portfolio</span></button>
            <button class="resume-btn flex justify-center items-center py-2 px-4 bg-sky-500 hover:bg-sky-700 rounded text-white text-center font-semibold w-44" href=""><i class="fa-solid fa-file-lines"></i><span class="ml-2 mt-1">View Resume</span></button>
        </div>
      </div>

      <div class="col-end-4">
        <img class="rounded-xl" src="../assets/headshot.jpeg" alt="">
      </div>
    </div>
  </div>
</template>
