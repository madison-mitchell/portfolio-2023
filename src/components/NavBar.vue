  ...
  <div class="navBar bg-gradient-to-b from-cyan-500 to-blue-500 h-screen flex flex-col">
    ...
    <nav class="flex flex-col items-center w-full">
      <ul class="text-left text-white font-medium">
        ...
        <li class="flex items-center p-2 hover:text-sky-700 active:text-sky-900"><a href=""><i class="fa-solid fa-file-lines text-center w-6"></i><span class="ml-2 mt-1">Resume</span></a></li>
      </ul>
